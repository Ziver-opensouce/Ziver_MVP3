...
export type EscrowSMConfig = {};

export function escrowSMConfigToCell(config: EscrowSMConfig): Cell {
...
export class EscrowSM implements Contract {
    ...
    static createFromConfig(config: EscrowSMConfig, code: Cell, workchain = 0) {
